            ...
            <section className="w-full max-w-xl py-6">
              ...
              <div className="flex flex-col overflow-hidden rounded-lg bg-white shadow-sm dark:bg-gray-800 dark:text-gray-100">
                <div className="grow p-5 md:px-16 md:py-12">
                  ...
                  >
                    ...
                    <div>
                      <button
                        type="submit"
                        className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-gray-900 bg-gray-800 px-6 py-3 font-semibold leading-6 text-white hover:border-gray-700 hover:bg-gray-600 hover:text-white focus:ring focus:ring-blue-400/50 active:border-blue-700 active:bg-blue-700 dark:focus:ring-blue-400/90"
                      >
                        <svg
                ...
                <div className="grow bg-gray-50 p-5 text-center text-sm dark:bg-gray-700/50 md:px-16">
                  ...
                  <Link
                    to="/login"
                    className="font-medium text-gray-600 hover:text-gray-400 dark:text-blue-400 dark:hover:text-blue-300"
                  >
                    Login
                  </Link>
                </div>
